...
## Installation
Talisman requires [Lovely](https://github.com/ethangreen-dev/lovely-injector) and [nativefs](https://thunderstore.io/package/download/metherul/nativefs/1.0.1/) to be installed in order to be loaded by Balatro. The code for Talisman must be installed in `%AppData%/Balatro/Mods/Talisman`.
